...
The handoff records the verified pre-write SHA as its evidence anchor. Because a commit cannot contain its own SHA, record the post-write SHA in independently observed controller evidence or a later handoff; never describe a handoff commit as self-verifying.
